...
<head>
    ...
    <title>Event Wise Guest Lists</title>
</head>
<body>
        ...
        <nav>
            <div class="logo">
                <a href="adminIndex.php">
                    <label class="brand">EventNow</label>
                </a>
            </div>
            <ul class="menu-nav">
                <li>
                    <a href="event_wise_guests.php" class="active">
                        Event Wise Guests
                    </a>
                </li>
                <li>
    ...
    <section class="events" style="margin-top: 100px; margin-bottom: 230px;">
            <div class="container my-5 text-center">
                <h1 class="title display-4">Event Wise Guest List</h1>
            ...
            <table class="table text-center shade">
                ...
                <tbody>
                    <?php 
                        $sQuery = "SELECT * FROM guests ORDER BY eventName LIMIT 25";
    ...
    <footer>
        <div class="container-fixed p-3">
            <p class="text-center text-white p-2">|----------Copyright &copy; 2020----------|</p>
            <div class="row text-center text-white">
                <div class="col-md-3">
                    <h1 style="font-weight: bold;">Vishwakarma Institue of Technology</h1>
                </div>
                <div class="col-md-6">
                    <p>Address:<br>Uppser Indira Nagar, Bibwewadi, Pune, Maharashtra 411037</p>
                    <h4>Designed & Developed By SY-IT</h4>
                </div>
                <div class="col-md-3">
                    <h1>Follow Us On</h1>
